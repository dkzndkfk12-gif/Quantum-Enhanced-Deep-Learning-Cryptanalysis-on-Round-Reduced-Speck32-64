...
# =========================
MODEL_PATH = 'resnet_r6_conv_aligned_gohr_block.pth'
WKR_PATH = 'resnet_wkr_r6.npz'
OUTPUT_PATH = 'resnet_bayes_one_round.npz'
...
class ResNetDistinguisher(nn.Module):
    def __init__(self, num_filters=NUM_FILTERS, hidden_dim=HIDDEN_DIM, depth=DEPTH):
        ...
        self.fc1 = nn.Linear(num_filters * WORD_LEN, hidden_dim, bias=True)
